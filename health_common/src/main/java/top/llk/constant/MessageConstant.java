...
public class MessageConstant {
    ...
    public static final String DELETE_PERMISSION_FAIL = "删除权限成功";
    ...
    public static final String EDIT_PERMISSION_FAIL = "编辑权限";
    ...
    public static final String MONTH_ERROR = "请输入正确的起止月份";
    ...
    public static final String GET_USER_SUCCESS = "获取用户列表成功";
    public static final String GET_USER_FAIL = "获取用户列表失败";
